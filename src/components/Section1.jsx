...
import shoeimg1 from '../assets/images/shoeimg1.png'
import shoeimg2 from '../assets/images/shoeimg2.png'
import shoeimg3 from '../assets/images/shoeimg3.png'
import shoeimg4 from '../assets/images/shoeimg4.png'
                ...
                <Row className='py-5'>
                    ...
                    <Col xl={6} className='pt-5 mt-4 mt-xl-0 ps-xl-5'>
                        ...
                        <div className='d-flex align-items-center pt-2'>
                            ...
                            <p className='mb-0 fw-normal lh-134 color-rgba fs-md ff-poppins ps-2 pt-1'>( 5 Customer Review )</p>
                        </div>
                        <p className='fs-md ff-poppins lh-185 color-black op-6 fw-normal pt-4 pb-xl-5 pb-3 max-width-610'>Sed nec ultricies felis,
                            vitae
                            facilisis
                        ...
                        <div class="d-flex align-items-center gap-3 pt-3">
                            ...
                            <div class="border d-flex align-items-center justify-content-center gap-3">
                                <div class="color-grey ff-josefin fs-20 lh-125 fw-normal bg-transparent border-none">
                                    <label for="cars" hidden>S</label>
                                    <select name="cars" id="cars" class="border-none outline-none pe-4 ff-josefin color-grey fs-md fw-normal lh-125">
                        ...
                        <div class="d-flex align-items-center gap-2 pt-3">
                            <p class="color-black ff-poppins lh-125 fw-medium fs-md mb-0 pt-1">Color:</p>
                            <div class="color-border mt-2 ms-3">
                        ...
                        <div class="d-flex gap-5 pt-4 align-items-center">
                            ...
                            <div class="d-flex cursor-pointer heart">
